...
public class OpenCVCameraPreview extends JavaCameraView
{
    private static final String TAG = "Sample::OpenCVCameraPreview";
    ...
    public void takePicture(final String fileName) {
        Log.i(TAG, "Capturing picture now");
